...
public class Arquero extends personajesAliados {
    ...
    public Arquero(String colorPiel, String colorCabello, int HP, int AP, int AD, int Eficacia, int Pc, int Velocidad, int edad, String nombre, int peso, int estatura) {
