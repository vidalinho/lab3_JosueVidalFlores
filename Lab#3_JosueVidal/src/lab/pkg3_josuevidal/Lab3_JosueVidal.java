...
public class Lab3_JosueVidal {
    ...
    public static void main(String[] args) {
        ...
        String colorPiel = "", colorCabello = "", nombre = "";
        ...
        while (opc == 1 || opc == 2) {
            ...
            switch (opc) {
                case 1:
                    ...
                    switch (opc2) {
                        case 1:
                            p = new mago(colorPiel, colorCabello, HP, AP, AD, Eficacia, Pc, Velocidad, edad, nombre, peso, estatura);
                            break;
                        case 2:
                            p = new Berzerk(colorPiel, colorCabello, HP, AP, AD, Eficacia, Pc, Velocidad, edad, nombre, peso, estatura);
                            break;
                        case 3:
                            p = new Arquero(colorPiel, colorCabello, HP, AP, AD, Eficacia, Pc, Velocidad, edad, nombre, peso, estatura);
                            break;
                        case 4:
                            p = new Picaro(colorPiel, colorCabello, HP, AP, AD, Eficacia, Pc, Velocidad, edad, nombre, peso, estatura);
                            break;
                    }
